 ...
 * in a {@link NebDeviceListActivity}.
 */
public class NebDeviceDetailActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_nebdevice_detail);
...
//        });
        ...
        if (savedInstanceState == null) {
            ...
            Neblina nebdev = (Neblina) getIntent().getParcelableExtra(NebDeviceDetailFragment.ARG_ITEM_ID);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            //
            navigateUpTo(new Intent(this, NebDeviceListActivity.class));
            return true;
        }
